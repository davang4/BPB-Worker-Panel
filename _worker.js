...
const getNormalConfigs = async (env, hostName, client) => {
    ...
    Addresses.forEach((addr) => {
        let remark = `https://t.me/bypassingsanction - ${addr}`;
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = 'https://t.me/bypassingsanction Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    Addresses.forEach((addr, index) => {
        ...
        let remark = `https://t.me/bypassingsanction Frag - ${addr}`;
        delete outbound.mux;
    ...
    bestPing.remarks = 'https://t.me/bypassingsanction Frag - Best Ping 💥';
